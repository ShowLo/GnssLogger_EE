...
/** The UI fragment that hosts a logging view for simulation. */
public class SimulationFragment extends Fragment {
  ...
  private final UiSimulationFragmentComponent mUiComponent = new UiSimulationFragmentComponent();

  public void setmFileLoggerSimulation(FileLoggerSimulation value) {
    mFileLoggerSimulation = value;
  }

  public void setSimulationCalculator(SimulationCalculator value) {
    mSimulationCalculator = value;
  }
  ...
  public View onCreateView(
    ...
    SimulationCalculator currentSimulationCalculator =
        mSimulationCalculator;
    if (currentSimulationCalculator != null) {
      currentSimulationCalculator.setUiSimulationComponent(mUiComponent);
    }
    ...
    mStartLog.setOnClickListener(
        new OnClickListener() {
          ...
          public void onClick(View view) {
            ...
            mFileLoggerSimulation.startLogSimulation();
            }
        });
    mStopLog.setOnClickListener(
        new OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            mFileLoggerSimulation.stopLogSimulation();
          }
        }
    );
   ...
   */
  public class UiSimulationFragmentComponent {
