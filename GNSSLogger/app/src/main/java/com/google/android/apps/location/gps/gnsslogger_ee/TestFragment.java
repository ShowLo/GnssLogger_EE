...
public class TestFragment extends Fragment {
  ...
  private final UiTestFragmentComponent mUiComponent = new UiTestFragmentComponent();

  public void setFileLoggerPseudolite(FileLoggerPseudolite value) {
    mFileLoggerPseudolite = value;
  }

  public void setTestCalculator(TestCalculator value) {
    mTestCalculator = value;
  }
  ...
  public View onCreateView(
    ...
    TestCalculator currentTestCalculator =
        mTestCalculator;
    if (currentTestCalculator != null) {
      currentTestCalculator.setUiTestComponent(mUiComponent);
    }
   ...
   */
  public class UiTestFragmentComponent {
